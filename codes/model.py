...
class DocREModel(nn.Module):
    def __init__(self, config, args, model, emb_size=1024, block_size=64, num_labels=-1):
        super().__init__()
        set_seed(args)
        self.config = config
        self.model = model
    ...
    def forward(self,
        ...
        output = (self.loss_fnt.get_label(logits, num_labels=self.num_labels), logits, bl)
